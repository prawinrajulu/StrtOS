...
export const CommandCenterPage: React.FC = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (data) {
        setOverview(data);
        if (data.active_decisions && data.active_decisions.length > 0) {
  ...
  const decision = overview?.active_decisions && overview.active_decisions.length > 0 ? overview.active_decisions[0] : null;
        ...
        <div className="p-6 bg-slate-900/60 border border-slate-800 rounded-xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-slate-950/80 border border-rose-900/60 rounded-lg space-y-2">
              ...
              {alternatives && alternatives.find((a: DecisionAlternative) => a.option_type === 'DO_NOTHING') && (
            ...
            <div className="p-4 bg-slate-950/80 border border-cyan-800/60 rounded-lg space-y-2">
              ...
              {alternatives && alternatives.find((a: DecisionAlternative) => a.option_type === 'RECOMMENDED_ACTION') && (
          ...
          {consensus && (
            <div className="p-4 bg-slate-950/60 border border-slate-800 rounded-lg space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {consensus.supporting_agents && consensus.supporting_agents.map((ag: string) => (
